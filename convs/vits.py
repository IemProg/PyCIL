...
def vit_tiny_patch16_224_in21k(pretrained=True, adapter=False, **kwargs):
    ...
    model = _create_vision_transformer('vit_tiny_patch16_224_in21k', pretrained=pretrained,
...
def vit_large_patch16_224_in21k(pretrained=True, adapter=False, **kwargs):
    ...
    model = _create_vision_transformer('vit_large_patch16_224_in21k', pretrained=pretrained,
                                       **dict(model_args, **kwargs))
    del model.head
    del model.norm
